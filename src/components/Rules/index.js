...
const Rules = () => (
  <div className="rules">
    ...
    {/* <p className="rules__h2">Introduction</p>
    ...
    <p className="rules__h2">Caractéristiques des entités</p>
    ...
    <p className="rules__h2">Classes jouables</p>
    ...
    <p className="rules__h2">Les jets</p>
    ...
    <p className="rules__h2">Conditions de réussite d'un jet d'action</p>
    ...
    <p className="rules__h2">Equipements</p>
    ...
    <p className="rules__h2">L'inventaire</p>
    ...
    <p className="rules__h2">Interface de jeu en dehors des combats</p>
    ...
    <p className="rules__h2">Interface de jeu durant les combats</p>
    {/* à compléter */}
